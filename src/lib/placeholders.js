    ...
    // primaryHero
    {
      ...
      spread: {
        reference: {
          ...
          previewImage: {
            url: 'https://cdn.shopify.com/s/files/1/0717/1597/9556/files/photo-1542291026-7eec264c27ff.jpg?v=1675842119',
          },
      ...
      spreadSecondary: {
        reference: {
          ...
          previewImage: {
            url: 'https://cdn.shopify.com/s/files/1/0717/1597/9556/files/istockphoto-1303978937-170667a.jpg?v=1675842119',
          },
    ...
    // secondaryHero
    {
      ...
      spread: {
        reference: {
          ...
          previewImage: {
            url: 'https://cdn.shopify.com/s/files/1/0717/1597/9556/files/lady-bag.jpg?v=1675842120',
          },
    ...
    // tertiaryHero
    {
      ...
      spread: {
        reference: {
          ...
          previewImage: {
            url: 'https://cdn.shopify.com/s/files/1/0717/1597/9556/files/download.jpg?v=1675842119',
          },
      ...
      spreadSecondary: {
        reference: {
          ...
          previewImage: {
            url: 'https://cdn.shopify.com/s/files/1/0717/1597/9556/files/download_1.jpg?v=1675842120',
          },
